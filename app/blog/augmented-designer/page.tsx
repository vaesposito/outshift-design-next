      ...
      <main>
        <div className="article-wrap">
          ...
          <div className="article-body">
            ...
            <p>Our current stack—Figma with generative plugins, AI-powered IDE assistants, and sharing generated code on GitHub—is pulling us closer to the engineering space than ever before.</p>
