...
const CARDS: BlogCard[] = [
  ...
  {
    href: '/blog/building-accessible-interfaces',
    external: false,
    gradient: 'linear-gradient(135deg, #1e3a5f 0%, #2a5298 100%)',
    imageAlt: 'Building Accessible Interfaces',
    tags: ['design', 'product-design'],
    tagLabels: ['Design', 'Product Design'],
    title: 'Building Accessible Interfaces: A Practical Guide',
    desc: 'A practical guide to building accessible interfaces — from design foundations and component architecture to scaling across teams and measuring success.',
    author: 'Valentina Esposito',
    date: 'March 2026',
    readLabel: '8 min read',
  },
  {
    ...
    external: false,
    gradient: 'linear-gradient(135deg, #0a3d5c 0%, #1a6e5c 100%)',
    imageAlt: 'The Future of Design Systems',
    tags: ['design', 'product-design'],
    tagLabels: ['Design', 'Product Design'],
    title: 'The Future of Design Systems: Scalability and Consistency',
    desc: 'How we built a design system that scales across hundreds of products — covering foundations, component architecture, governance, and measuring success.',
    author: 'Jaime Holland',
    date: 'March 2026',
